              ...
              <div class="app-brand justify-content-center">
                <a href="{{ url('/') }}" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <!-- Sneat SVG Logo (replace with your actual SVG if needed) -->
                  ...
                  <span class="app-brand-text demo text-heading fw-bold">trustee</span>
                </a>
              </div>
              <!-- /Logo -->

              <h4 class="mb-1">Welcome to our institute! 👋</h4>
